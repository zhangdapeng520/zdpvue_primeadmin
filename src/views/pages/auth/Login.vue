            ...
            <div
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <span class="text-muted-color font-medium">请在下方填写您的登录账号信息</span>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                            <div class="flex items-center">
                                <Checkbox v-model="is_remember" id="is_remember" binary class="mr-2"></Checkbox>
                                <label for="is_remember">记住我</label>
                            </div>
                            <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">
                                忘记密码？
                            </span>
                        </div>
                        <Button label="立即登录" class="w-full" @click="onLogin"></Button>
                    </div>
                </div>
            </div>
        </div>
